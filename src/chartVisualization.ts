...
export const chartVisualizationUpdateSchema = z.object({
  ...
  xAxis: z.record(z.string(), z.any()).optional(),
  yAxis: z.array(z.record(z.string(), z.any())).optional(),
  error_y: z.record(z.string(), z.any()).optional(),
  series: z.record(z.string(), z.any()).optional(),
  seriesOptions: z.record(z.string(), z.any()).optional(),
  valuesOptions: z.record(z.string(), z.any()).optional(),
  columnMapping: z.record(z.string(), z.union([z.string(), z.array(z.string()), z.null()])).optional(),
